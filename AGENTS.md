...
Always inspect the repository before implementing. Prefer incremental commits or clearly separated change sets if the environment supports that, but work in larger batches to minimize user prompts.
