...
| `@Manifold/private/coeffs_conj2full.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
| `@Manifold/private/coeffs_conj2lex.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
| `@Manifold/private/coeffs_lex2revlex.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
| `@Manifold/private/coeffs_mixed_terms.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
| `@Manifold/private/coeffs_output.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
| `@Manifold/private/coeffs_setup.m` | manifold coefficient API | `ssmtoolpy.manifold` | not yet ported | not yet verified |
